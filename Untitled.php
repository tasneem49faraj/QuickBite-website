  ...
  <body>
    ...
    <section>
      <div class="cont">
       ...
       <div class="con2">
            <div class="con3">
                <div class="icon">  <button  type='button'onclick="test(1)" >soso</button><i class="fa-solid fa-bowl-food"></i></a></div>
                 <div class="con4"><h2>appetizers</h2>
                 <h5>Perfect party appetizers</h5></div>
             </div>
             <div class="con3">
                <div class="icon">    <button  type='button' onclick='test("2")'  ></button><i class="fa-solid fa-martini-glass-citrus"></i></a></div>
                 <div class="con4"><h2>Juices</h2>
                 <h5>Very delicious juices</h5></div>
             </div>
             <div class="con3">
                <div class="icon">   <button  type='button' onclick='test("3")'  ></button><i class="fa-solid fa-drumstick-bite"></i></a></div>
                 <div class="con4"><h2>Main meal</h2>
                 <h5>The best main meal</h5></div>
             </div>
             <div class="con3">
                <div class="icon">   <button  type='button' onclick='test("4")'  ></button><i class="fa-solid fa-cake-candles"></i></a></div>
                 <div class="con4"><h2>dessert</h2>
                 <h5>We have a wonderful dessert</h5></div>
             </div>
             <div class="con3">
                <div class="icon">    <button  type='button' onclick='test("5")'  ></button><i class="fa-solid fa-bread-slice"></i></a></div>
                 <div class="con4"><h2>Freshbread</h2>
                 <h5 >delicious bread </h5></div>
             </div>
            </div>
